      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <div className="inline-block bg-gradient-to-br from-zinc-800/60 to-zinc-900/60 border border-green-500/50 rounded-lg px-4 sm:px-6 py-2 mb-6 sm:mb-8">
            <span className="text-white text-xs sm:text-sm font-medium tracking-wide">Success Stories</span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16 lg:mb-20 max-w-6xl mx-auto mt-12 sm:mt-16 lg:mt-20">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="relative bg-gradient-to-br from-zinc-900/60 to-zinc-950/80 border border-zinc-800/50 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mt-8 sm:mt-12">
          <button className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-3 bg-background-card border-2 border-green-500 rounded-full text-white font-semibold text-sm sm:text-base flex items-center justify-center gap-2 hover:border-green-400 transition-all duration-300">
            View More
